...
class MiniCart extends DataExtension {
	...
	protected static $pay_pal_url	= "https://www.paypal.com/cgi-bin/webscr";
	
	protected static $cart_config = array(
		"parent" => "paypal_holder",
		"target " => "paypal_holder"
	);
	...
	public static function set_sandbox($sandbox) {
		self::$pay_pal_url = ($sandbox == true)? "https://sandbox.paypal.com/cgi-bin/websc" : "https://www.paypal.com/cgi-bin/webscr";
	}
