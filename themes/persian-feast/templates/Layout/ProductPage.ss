<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 productsContainerControls">
    ...
    <div class="container products_wrapper">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body retailInfoModal">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 prod-modal-inner-right" style="padding-top: 2% !important;">
                                                <h4>$Title</h4>
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 shopping_cart_anchor">
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 shoppingCartContainer" id="sticky">
                <i class="fa fa-shopping-cart pull-left" style="margin-left: 10px; font-size: 2em; margin-top: 13px; color: orange;"></i><h4>Your Shopping Cart</h4>
